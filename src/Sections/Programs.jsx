...
const Programs = () => {
    return (
      ...
      <Link to="/toronto-jiu-jitsu-classes" className="program-item-link"><div className="program-item jiu-jitsu"><div className="program-text">JIU JITSU</div></div></Link>
        <Link to="/toronto-kickboxing-classes" className="program-item-link"><div className="program-item kickboxing"><div className="program-text">KICKBOXING</div></div></Link>
