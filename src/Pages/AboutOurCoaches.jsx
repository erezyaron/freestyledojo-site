...
const AboutOurCoachesPage = () => {
   ...
   const topProps = {
    ...
    buttons: [
      ...
      { label: "private lessons", action: "/contact-free-trial-class" },
    ],
  };

  return (
    <Layout topProps={topProps}>
      <p className="info-section" >The Freestyle Dojo coaches bring their diverse martial arts backgrounds to their classes for a holistic approach to martial arts training.</p>
      <TwoPartSection
...
export default AboutOurCoachesPage;
